...
a_precut, b_precut, c_precut, v_precut = solve_ivp_odes(number_of_cells_precut, number_of_timepoints_precut, dt, dx, a0, b0, c0, v0, calcium_periodic_boundary, params)
...
a_postcut_short, b_postcut_short, c_postcut_short, v_postcut_short = solve_ivp_odes(number_of_cells_postcut, number_of_timepoints_postcut, dt, dx, a_atcut, b_atcut, c_atcut, v_atcut, calcium_no_flux_boundary, params)
...
t = np.concatenate((t_precut, t_postcut))
...
create_animated_output(number_of_cells_precut, sample_rate, t_relative_to_cut, a, b, v, c, save_directory)
